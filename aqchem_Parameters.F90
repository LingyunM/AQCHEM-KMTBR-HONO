...
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: LU_NONZERO = 331 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_A_NO2AKN = 100 
  INTEGER, PARAMETER :: ind_WD_HNO2 = 101
  INTEGER, PARAMETER :: ind_WD_NO2MIN = 102
  INTEGER, PARAMETER :: ind_G_HNO2 = 103
  INTEGER, PARAMETER :: ind_L_HNO2 = 104 
  INTEGER, PARAMETER :: ind_L_NO2MIN = 105 


! Index declaration for fixed species in C
!   C(ind_spc)

  INTEGER, PARAMETER :: ind_L_H2O = 106 
  INTEGER, PARAMETER :: ind_L_HO = 107 
  INTEGER, PARAMETER :: ind_DUMMY = 108 
